...
cmake ../llvm -G Ninja -DCMAKE_BUILD_TYPE='RelWithDebInfo' -DLLVM_ENABLE_ASSERTIONS='ON' -DLLVM_ENABLE_PROJECTS='clang' -DLLVM_INCLUDE_EXAMPLES='OFF' -DLLVM_INCLUDE_TESTS='OFF' -DLLVM_INCLUDE_BENCHMARKS='OFF' -DLLVM_TARGETS_TO_BUILD='X86' -DLLVM_ENABLE_BINDINGS='OFF' -DLLVM_BUILD_DOCS='OFF' -DLLVM_USE_LINKER=lld 
```
