...
3. Let's manually link the SDL2main.lib
	...
	4. Then told linker to link the `SDL2maind.lib`, go to **Configuration Properties -> Linker -> Additional Dependencies -> Edit** <br>![Alt Text](da19ujcimiynr4abkd0j.png)<br>Then add <br><img src="/shared/imgs/image-20210323170344998.png" alt="image-20210323170344998" style="zoom: 67%;" />
